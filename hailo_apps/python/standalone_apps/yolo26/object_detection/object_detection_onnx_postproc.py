...
try:
    ...
    from hailo_apps.python.standalone_apps.yolo26.object_detection.object_detection_utils import inference_result_handler as yolo26_inference_result_handler
